...
const allBlogs = [blog2, blog3, blog4, blog5, blog6, blog7, blog8, blog9, blog10];
db.blogs.insertMany(allBlogs);

 - Insert new blog into collection:

 db.blogs.insertOne({
    "createdAt": new Date(),
    "title": "new blog",
    "text": "Sample text for blog here words words words blah blah blah",
    "author": "Darriel Morris",
    "lastModified": new Date(),
    "categories": ["esse", "dolor"],
    "id": "53c6e1237d81-4a571289-6d5c",
    "objectId": 11
});
